...
<body id="page-main">
  <div id="container">
    ...
    <ul id="nav-aux" class="clearfix">
      <li class="about" onclick="$.address.value('homes/about');"><a>About Us</a></li>
      <li class="contact" onclick="$.address.value('homes/contact');"><a>Contact Us</a></li>
      <li class="press" onclick="$.address.value('homes/press');"><a>Press Page</a></li>
    </ul>
	<ul id="social">
