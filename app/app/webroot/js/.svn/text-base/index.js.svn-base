...
function formatItem(row) {
  return '<table><tr><td><img src="img/profiles/' + row[0] + '.jpg" style="width: 45px; padding: none; border:2px solid #C0C0C0;"></td><td style="font-size: 80%; padding-left: 10px; vertical-align:top;"><strong>' + row[0] + '</strong><br><font style="font-size:75%;">' + "Details: " + row[1] + '</font></td></tr></table>';  
}
